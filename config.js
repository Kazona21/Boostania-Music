    ...
    constructPrimaryConfigurationSchema() {
        return {
            ...
            bot: {
                ...
                ownerIds: ["779507251282968587"],      // 👈 ADD YOUR DISCORD ID HERE
                embedColor: 0x00AE86,               // 👈 Bot embed color (hex)
                supportServer: "https://discord.gg/cqJkPppmD5",    // 👈 Your support server link
                defaultStatus: "🎵 Boostania Music!"         // 👈 Bot status message
            },
