        ...
        try {
            const embed = new EmbedBuilder()
                ...
                .setDescription(
                    ...
                    '[Support Server](https://discord.gg/cqJkPppmD5)\n\n' +
                    'For direct inquiries, contact: **Kazochim**\n\n' +
                    'Website: https://e-z.bio/kazona'
                )
                .setTimestamp()
                .setFooter({ text: 'Boostania Music Bot • Developed by Kazochim' });
