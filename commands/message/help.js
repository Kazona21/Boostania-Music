...
module.exports = {
    ...
    async execute(message, args, client) {
        ...
        try {
            ...
            let description = `**🌐 Thống kê Bot:** Đang có mặt trên **${client.guilds.cache.size}** máy chủ.\n\n`;
            ...
            const embed = new EmbedBuilder()
                .setTitle('📖 Boostania Music Bot - Command List')
                .setColor(0x1DB954)
                .setDescription(description)
                .setFooter({ text: 'Developed by Kazochim | https://e-z.bio/kazona' })
                .setTimestamp();
            ...
            await message.reply('❌ Đã xảy ra lỗi khi lấy lệnh..');
        }
    }
};
